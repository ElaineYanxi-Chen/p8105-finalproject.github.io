...
**$H_0$**: The number of abortions per 1000 live births is the same across all NY state counties.

**$H_1$**: The number of abortions per 1000 live births is not the same across all NY state counties.
...
- The data provides sufficient evidence to support the hypothesis that overall abortion rates differs across NY state counties.
...
**$H_0$**: The expected counts of abortions in each race category are the same across all NY state counties.

**$H_1$**: The expected counts of abortions in each race category are not the same across all NY state counties.
...
**$H_0$**: The expected counts of abortions in each finance plan category are the same across all NY state counties.

**$H_1$**: The expected counts of abortions in each finance plan category are not the same across all NY state counties.
...
**$H_0$**: The expected counts of abortions in each age category are the same across all NY state counties.

**$H_1$**: The expected counts of abortions in each age category are not the same across all NY state counties.
...
abortion_totals %>% 
  select (-total) %>%
  knitr::kable(caption = "Proportion T-Test for NYC and NY State", col.names = c("Region", "Abortions per 1000 births"), align = c('l', 'c'), format = "simple")
```
