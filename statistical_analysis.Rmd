...
NY_age_clean %>% 
  knitr::kable(caption = "Chi-Square Test for Age and Counties", col.names = c("Regions", "Borough/County", "< 20 years", "20-24 years", "25-29 years", "30-34 years", "35-39 years", "40+ years"), align = c('l', 'c', 'c', 'c', 'c', 'c', 'c'), format = "simple" )
```
