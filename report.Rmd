...
Our year of interest is 2019, which is the most recent dataset provided by New York State. We will be focusing on the numbers of induced abortions in New York City and New York State and compare the differences across the boroughs and counties. Different variables that we are interested are age, race, and financial plans. We are also interested on how the total rate of abortion changes over years from 2014 to 2019. 
...
- The two regions are categorized as follows:
  ...
  - New York State encompasses the remaining 57 counties, outside of New York City.

From the Vital Statistics of New York State 2019, we will use data from the *Induced Abortions* and *Live Births* section. 

## Data Scraping and Cleaning 

We first imported the data sets from the Vital Statistics of New York State 2019 webpage. We cleaned the data and merged the data to create a final master spreadsheet, which we will be pulling from for each of our analyses.
