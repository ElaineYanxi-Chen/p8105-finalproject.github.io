...
From the same dataset, we included `New York State` total, `New York City` total and any county with released abortion rate data. Therefore, the dataset includes the following variables: `r merged %>% pull(borough)`. One note to be aware of is that Essex and Hamilton data are combined in the dataset due to the formatting released by New York State, thus we have `Essex/Hamilton` as a variable
