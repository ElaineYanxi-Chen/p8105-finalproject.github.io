...
Our year of interest is 2019, which is the most recent dataset provided by New York State. We will be focusing on the numbers of induced abortions in New York City and New York State and compare the differences across the boroughs/ counties. 
...
age_nys = 
  ...
  ggplot(aes(x = age, y = abortion, fill= region, color= region)) + 
...
finance_nys = 
  ...
  ggplot(aes(x = finance_plan, y = abortion, fill= region, color= region)) + 
  geom_bar(stat = "identity", 
           position = "dodge")+
  theme(legend.position = "right")+
  labs(
...
race_nys = 
  ...
  ggplot(aes(x = race, y = abortion, fill= region, color= region)) + 
  geom_bar(stat = "identity", 
           position = "dodge")+
